...
<div>
	<ul class="nav nav-pills">
	  ...
	  <li><a href="#" onclick="formSubmit('warehouseAction_insert','_self')"><img alt="modify" src="${ctx }/img/save.png"></a></li>
	</ul>
</div>
...
<div class="col-md-4" style="margin-top: 30px">
	...
	<div class="form-group">
		<label for="firstname" class="col-md-3 control-label">仓库名</label>
		<div class="col-md-9">
			<input type="text" class="form-control" id="firstname" 
				   name="name" placeholder="请输入仓库名" value="${name }">
		</div>
	</div>
</div>
</div>
