...
<script>
     ...
     function deleteById(){
    	 ...
    	 if(count > 0){
    	 	 alert("确认删除？");
    		 formSubmit('stockInAction_deleteStockGood_fromCreate','_self');
    	 }else{
     ...
     function toUpdate(){
    	 if(isOnlyChecked()){
    		 formSubmit('stockInAction_toupdate','_self')
    	 }else{
    		 alert("请先选择一项并且只能选择一项，再进行操作！");
    	 }
     }
...
<div>
	<ul class="nav nav-pills">
	  <li><a href="#" onclick="formSubmit('stockInAction_list','_self')"><img alt="add" src="${ctx }/img/back.png"></a></li>
	  <li><a href="#" onclick="formSubmit('stockInAction_addOneGood','_self')"><img alt="add" src="${ctx }/img/add.png"></a></li>
...
<div class="col-md-4" style="margin-top: 30px">
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			<s:select cssClass="form-control" name="stockGood.good.id" list="#goods" headerKey="" headerValue="--请选择--" listKey="id" listValue="name"></s:select>
		</div>
	</div>
</div>
...
<div class="col-md-4" style="margin-top: 30px">
	...
	<div class="form-group">
		...
		<div class="col-md-9">
			<input type="text" class="form-control" name="stockGood.amount" placeholder="请输入数量" value="${stockGood.amount }">
		</div>
	</div>
</div>
