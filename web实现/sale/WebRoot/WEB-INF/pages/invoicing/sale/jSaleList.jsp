...
<div>
	<ul class="nav nav-pills">
	  ...
	  <li><a href="#" onclick="formSubmit('saleAction_toupdate','_self')"><img alt="modify" src="${ctx }/img/modify.png"></a></li>
	  <li><a href="#" onclick="formSubmit('saleAction_delete','_self')"><img alt="delete" src="${ctx }/img/delete.png"></a></li>
	</ul>
</div>
