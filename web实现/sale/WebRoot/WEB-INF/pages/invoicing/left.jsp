...
<div style="padding: 10px">
	<ul class="nav nav-pills nav-stacked">
		...
		<li id="li2" onclick="changeStyle('li2')"><a href="invoicing/stockAction_listin" target="mainFrame">入库单</a></li>
		<li id="li3" onclick="changeStyle('li3')"><a href="invoicing/stockAction_listout" target="mainFrame">出库单</a></li>
