...
<script>
     ...
     function deleteById(){
    	 ...
    	 if(count > 0){
    	 	 alert("确认删除？");
    		 formSubmit('stockAction_deleteStockGood_fromCreate','_self');
    	 }else{
...
<div>
	<ul class="nav nav-pills">
	  <li><a href="#" onclick="formSubmit('stockAction_list','_self')"><img alt="add" src="${ctx }/img/back.png"></a></li>
	  <li><a href="#" onclick="formSubmit('stockAction_addOneGood','_self')"><img alt="add" src="${ctx }/img/add.png"></a></li>
